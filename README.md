# Codename Carpathia
Codename Carpathia is an unreleased Scratch OS developed by [@BambusOS](https://scratch.mit.edu/users/BambusOS/), [@Scratch_Fakemon](https://scratch.mit.edu/users/Scratch_Fakemon/) and [@PaweR_Develop](https://scratch.mit.edu/users/PaweR_Develop/) (PaweR). The OS has been in development since August 2025 as a testing bed for new technologies up until June 2026. On the 15th August 2026, developers of Carpathia decided to cease development and release the OS and its associated concept art to the **public domain**.
...
The OS does not have a functional GUI or terminal, however it was developed with a GUI in mind. There are no terminal facilities available in the OS.
